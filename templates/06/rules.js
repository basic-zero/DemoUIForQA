...
(() => {
  ...
  const labels={profiles:'Profile 360',dashboard:'Tổng quan',admissions:'Tuyển sinh',tasks:'Công việc / Hạn xử lý',inbox:'Tin nhắn',reports:'Báo cáo',campaigns:'Chiến dịch',operations:'Quy tắc / Cài đặt',omnichannel:'Tin nhắn đa kênh',forms:'Biểu mẫu đăng ký',outbound:'Chăm sóc hàng loạt',advisors:'Đội ngũ tuyển sinh',referrals:'Phụ huynh giới thiệu',targets:'Chỉ tiêu tuyển sinh'};
